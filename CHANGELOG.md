...
Infinity UI - Compass Navigation Overhaul - Local Map Upgrade 
(We think Infinity UI based mods are causing weird UI issue. Removed them for this update if the issue still remains i will bring these back.)
